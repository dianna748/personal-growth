...
const I18N_DATA = {
  en: {
    ...
    'todo.section.dashboardHint': 'Task-chain totals, completion and trends',
    'cat.life': 'Life',
    'cat.work': 'Work',
    'cat.media': 'Media',
    'cat.study': 'Study',
    ...
    'todo.emptyDateTitle': 'Nothing planned for this date yet',
    'todo.emptyDateHint': 'Add one clear next step, or return to today.',
    'todo.allDoneTitle': 'Everything is complete',
    'todo.allDoneHint': 'Enjoy the space, or add the next thing that matters.',
    'todo.emptyFilterTitle': 'No tasks in this category',
    'todo.emptyFilterHint': 'Add one here or return to all categories.',
    'todo.emptyAddAction': 'Add a task',
    ...
    'dash.created': 'Actual tasks created',
    'dash.completed': 'Tasks completed',
    'dash.rollovers': 'Tasks rolled over',
    'dash.ontime': 'On-time completion',
    ...
    'todo.rolledBadgeN': 'Rolled ×{n}',
    'todo.toastEmpty': 'Please enter a task',
    'todo.toastAdded': 'Task added',
    'todo.listTitle': "Today's focus",
    'todo.daySummary': '{remaining} remaining · {done}/{total} done',
    ...
    'todo.dragToReorder': 'Drag to reorder within this priority; arrow keys also work',
  ...
  zh: {
    ...
    'todo.section.dashboardHint': '按任务链统计创建、完成与趋势',
    'cat.life': '生活',
    'cat.work': '工作',
    'cat.media': '自媒体',
    'cat.study': '学习',
    ...
    'todo.emptyDateTitle': '这一天还没有安排',
    'todo.emptyDateHint': '添加一个明确的下一步，或回到今天。',
    'todo.allDoneTitle': '这一天已经全部完成',
    'todo.allDoneHint': '享受留白，或者安排下一件真正重要的事。',
    'todo.emptyFilterTitle': '这个分类暂时没有任务',
    'todo.emptyFilterHint': '在这里添加一项，或返回全部分类。',
    'todo.emptyAddAction': '添加任务',
    ...
    'dash.total': '任务总数（累计）',
    'dash.topCat': '最常用分类',
    'dash.created': '实际创建任务数',
    'dash.completed': '完成任务数',
    'dash.rollovers': '延续任务数',
    'dash.ontime': '按时完成率',
    'dash.catDist': '分类分布',
    ...
    'todo.addedSuffix': '加入',
    'todo.rolledBadge': '顺延',
    'todo.rolledBadgeN': '顺延 ×{n}',
    'todo.toastEmpty': '请输入任务',
    'todo.toastAdded': '任务已添加',
    'todo.listTitle': '今日清单',
    'todo.daySummary': '剩余 {remaining} 项 · 已完成 {done}/{total}',
    'todo.hideCompleted': '隐藏已完成',
    'todo.showCompleted': '显示已完成',
    'priority.high': '高优先级',
    'priority.medium': '中优先级',
    'priority.low': '低优先级',
    'todo.changePriority': '修改优先级',
    'todo.dragToReorder': '拖动排序；聚焦后也可用上下方向键',
    'dn.prevDay': '前一天',
    'dn.nextDay': '后一天',
    'dn.todayBtn': '回到今天',
    'dn.viewDate': '单日',
  ...
  fr: {
    ...
    'todo.section.dashboardHint': 'Totaux par chaîne, complétion et tendances',
    'cat.life': 'Vie',
    'cat.work': 'Travail',
    'cat.media': 'Médias',
    'cat.study': 'Études',
    ...
    'todo.emptyDateTitle': 'Rien de prévu pour cette date',
    'todo.emptyDateHint': 'Ajoutez une prochaine étape claire ou revenez à aujourd’hui.',
    'todo.allDoneTitle': 'Tout est terminé',
    'todo.allDoneHint': 'Profitez de cet espace ou ajoutez la prochaine priorité.',
    'todo.emptyFilterTitle': 'Aucune tâche dans cette catégorie',
    'todo.emptyFilterHint': 'Ajoutez-en une ici ou affichez toutes les catégories.',
    'todo.emptyAddAction': 'Ajouter une tâche',
    ...
    'dash.created': 'Tâches réellement créées',
    'dash.completed': 'Tâches terminées',
    'dash.rollovers': 'Tâches reportées',
    'dash.ontime': 'Terminées à temps',
    ...
    'todo.rolledBadgeN': 'Reporté ×{n}',
    'todo.toastEmpty': 'Veuillez saisir une tâche',
    'todo.toastAdded': 'Tâche ajoutée',
    'todo.listTitle': 'Priorités du jour',
    'todo.daySummary': '{remaining} restantes · {done}/{total} terminées',
    'todo.hideCompleted': 'Masquer les terminées',
    'todo.showCompleted': 'Afficher les terminées',
    'priority.high': 'Haute',
    'priority.medium': 'Normale',
    'priority.low': 'Basse',
    'todo.changePriority': 'Modifier la priorité',
    'todo.dragToReorder': 'Glisser pour réordonner dans cette priorité ; les flèches fonctionnent aussi',
